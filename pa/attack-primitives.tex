...
\section{Attack Primitives} \label{sec:attack-primitives}
  ...
  \begin{itemize}
    \item \hyperref[sec:uncached]{\textbf{P1.} Uncached} \label{prim:uncached}
    \item \hyperref[sec:fast]{\textbf{P2.} Fast} \label{prim:fast}
    \item \hyperref[sec:targeted]{\textbf{P3.} Targeted} \label{prim:targeted}
  \end{itemize}
  ...
  \\
  The second prerequisite, \textbf{\hyperref[sec:fast]{P2. Fast}}, demands that memory accesses occur at a rate that outpaces 
  ...
  \\
  The third prerequisite, \textbf{\hyperref[sec:targeted]{P3. Targeted}}, specifies that memory accesses must be directed to 
