\section{Uncached} \label{sec:uncached}
    ...
    \subsection{Non-temporal accesses} \label{subsec:non-temporal-accesses}
        ...
        cache pollution~\cite{paperTriggeringRHHardwareFault}. This cache-bypassing capability significantly facilitates Rowhammer 
        attacks on x86 architectures, as demonstrated in~\cite{paperANewApproach}. However, as discussed in~\cite{paperDrammer}, ARMv8-A 
