...
\section{Conclusion} \label{sec:conclusion}
  ...
  conditions. However, certain limitations prevent a definitive conclusion regarding 
  ...
  attacks~\cite{paperRHonRi3B+}, and GPU-based hammering~\cite{paperOpenGL} on the Raspberry 
