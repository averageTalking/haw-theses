\section{Lab Setup} \label{sec:lab-setup}
  ...
  \subsection{System Setup} \label{subsec:system-setup}
    ...
    prepared for experimentation. \hyperref[tab:experimental-setups]{Table~\ref{tab:experimental-setups}} summarizes the experimental setups used in this 
    ...
    At the outset of the project, the test systems did not contain the data referenced in \hyperref[tab:experimental-setups]{Table~\ref{tab:experimental-setups}}, and the test 
