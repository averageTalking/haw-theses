\section{Lab Setup} \label{sec:lab-setup}
  ...
  \subsection{System Setup} \label{subsec:system-setup}
    ...
    ensuring that every subsequent memory access is served from \gls{dram}, as discussed in more detail in the 
    section~\hyperref[subsec:flush-cache]{Uncached}. Finally, a clean reinstallation reduced setup complexity by avoiding the need for eviction-set 
    ...
    instructions that are relevant in Section~\hyperref[subsec:flush-cache]{Uncached}, and are capable of executing kernel modules.
