\subsection{Cache eviction} \label{subsec:cache-eviction}
    ...
    \subsubsection{Eviction Development} \label{subsubsec:eviction-development}
        The cache eviction mechanism used in this work is based on the libflush source of the armageddon tool~\cite{toolArmageddon} proposed by Lipp et al.~\cite{paperARMageddon} and relies on the 
