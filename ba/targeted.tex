\section{Address Mapping Reconstruction} \label{sec:targeted}
    ...
    \subsection{Knock-Knock Approach} \label{subsec:knock-knock-approach}
    ...
    \subsection{Row Hit, Row Conflict Distinction} \label{subsec:row-hit-row-conflict-distinction}
    ...
    \subsection{DRAMA Approach} \label{subsec:drama-approach}
