\subsection{Reverse Engineering} \label{subsec:reverse-engineering}
    \subsubsection{Graph-Based Mapping Inference} \label{subsubsec:graph-based-mapping-inference}
        ...
        Analysis across all bit positions revealed that bits \texttt{12}, \texttt{13}, and \texttt{14} 
        consistently exhibit the highest average latencies, as seen in~\cref{fig:avg-latency-per-bit}.
