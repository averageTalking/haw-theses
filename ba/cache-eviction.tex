\subsection{Cache Eviction} \label{subsec:cache-eviction}
    ...
    \subsubsection{Cache Attacks} \label{subsubsec:cache-attacks}
        ...
        fine-grained resolution~\cite{paperRowhammerjs}. The basic idea proposed in~\cite{paperCacheGames} is 
        ...
        minimum due to the continuous cache flushes as seen in~\cite{paperFlushFlush} or on all of our test devices.
        \\ \\ % Evict+Time
        ...
        AES implementation in a cloud environment~\cite{paperSharedCacheAttack}. In the same year, Liu et al. used \textit{Prime+Probe} to construct a 
