%%%%% MAKE THIS BETTER
  % "Non-functional Requirements"
    % Lege dich auf eine Programmiersprache fest
%%%%%
\section{Methodology}
  ...
  \subsection{Research Design}
    ...
    \begin{table}[h!]
      ...
      \begin{tabular}{|l|l|l|l|}
        \hline
        \textbf{Platform} & \textbf{Architecture} & \textbf{SoC} & \textbf{DRAM} \\ \hline
        Raspberry Pi 4B & ARMv8 & Broadcom BCM2711 & 4 GB LPDDR4 \\ \hline
        Raspberry Pi 4B & ARMv8 & Broadcom BCM2711 & 8 GB LPDDR4 \\ \hline
        Raspberry Pi 5 & ARMv8 & Broadcom BCM2712 & 4 GB LPDDR4x \\ \hline
        Raspberry Pi 5 & ARMv8 & Broadcom BCM2712 & 8 GB LPDDR4x \\ \hline
        Raspberry Pi 5 & ARMv8 & Broadcom BCM2712 & 16 GB LPDDR4x \\ \hline
      \end{tabular}
    \end{table}
  ...
  \subsection{Requirements}
    ...
    \subsubsection{Functional requirements}
      ...
      of allocated RAM must be adjustable as a percentage of the available memory, and the framework must 
      incorporate bit masks and bank addressing functions. Automatic detection of hardware characteristics, 
      including the Raspberry Pi model, RAM size, and architecture, is required. Furthermore, the system must 
      support cache bypass mechanisms, virtual-to-physical-to-DRAM address mapping, and, if feasible, mitigation 
    ...
    \subsubsection{Non-functional requirements}
      The implementation must be realized using \textit{C}, \textit{C++}, or \textit{Python} and executed with root privileges in user space. 
      ...
      accidental harm and by emphasizing the responsible use of security attack techniques, ensuring that findings 
      are not applied to production systems.
