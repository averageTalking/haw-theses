\subsection{Flush cache} \label{subsec:flush-cache}
    ...
    instructions for this purpose, most notably the \texttt{DC CIVAC} instruction [Quote of ~159]. By directly 
    ...
    \subsubsection{Instruction Types} \label{subsubsec:instruction-types}
        ...
        instruction cleans and invalidates a data cache by address to \gls{poc} [152], while \texttt{DC CVAC} 
