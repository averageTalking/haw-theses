\section{Lab Setup} \label{sec:lab-setup}
  ...
  \subsection{System Setup} \label{subsec:system-setup}
    ...
    This paper primarily focuses on Rowhammer techniques targeting the ARMv8-A architecture. and \texttt{6.12.67-v8+}, respectively.
    While the Raspberry Pi 5 runs kernel version \texttt{6.12.67-v8-16k+}. As a 
