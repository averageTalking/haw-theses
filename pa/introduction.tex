\section{Introduction} \label{sec:introduction}
  ...
  followed by~\cref{sec:uncached}, \cref{sec:targeted}, and \cref{sec:fast} that describe the individual challenges in terms of implementation, design choices, and practical constraints. 
