\section{Address Mapping Reconstruction} \label{sec:targeted}
    ...
    \gls{dram} row within the same bank in order to gain bitflips in an adjacent victim row through produced row conflicts. 
    Notwithstanding, the exact informations of this physical-to-\gls{dram} address mapping are typically not publicly available.
