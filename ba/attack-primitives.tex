\section{Overview of Challenges} \label{sec:overview-of-challenges}
  ...
  \begin{description}
    \item[C1. Direct \gls{dram} Activation] \label{ch:uncached}
    ...
    \item[C2. Address Mapping Reconstruction] \label{ch:targeted}
    ...
    \item[C3. Outpacing \gls{dram} refresh] \label{ch:fast}
