\section{Address Mapping Reconstruction} \label{sec:targeted}
    ...
    To achieve the \hyperref[ch:targeted]{C2. Address Mapping Reconstruction} attack primitive, it is necessary to access a specific 
    ...
    \subsection{Methods} \label{subsec:methods}
        ...
        \\ \\
        \textbf{DRAMA}, introduced by Pessl et al. in 2016~\cite{paperDRAMA}, exploits a row-buffer timing side channel in which 
        ...
        \textit{Halfdouble}~\cite{paperHalfDouble, toolHalfDouble}, \textit{Drammer}~\cite{paperDrammer,toolDrammer}, and \textit{Cache Attacks and Rowhammer}~\cite{thesisCacheAttacksandRH}.
        \\
        The work titled \textbf{One Bit flips, one cloud flops}, introduced by Xiao et al. in 2016~\cite{paperOneBitFlipsOneCouldFlops}, proposes a 
        ...
        \\
        \textbf{Knock Knock}, introduced by Plin et al. in 2025~\cite{paperKnockKnock}, reformulates the identification of \gls{dram} parity 
