\section{Uncached} \label{sec:uncached}
    ...
    \subsection{Uncached memory} \label{subsec:uncached-memory}
        ...
        management interface~\cite{paperDrammer}. However, \cite{paperGuardION} has rendered Rowhammer attacks triggered in this 
        way non-exploitable. More generally, leveraging user-accessible \gls{dma} buffers on Android systems to 
