\section{Related Work} \label{sec:related-work}
  ...
  evicting cache lines from the CPU cache. This work showed that the previously 
  ...
  ARM cache maintenance instructions analogous to the case of x86.
  \\
  ...
  the likelihood of inducing repeated bit flips at specific memory locations.
  \\
  ...
  However, they observed and induced a closed-page policy on this system, influencing 
  ...
  Raspberry Pi models. However, no other embedded systems within the Raspberry Pi 
  ...
  explored to trigger Rowhammer faults with GPU-based memory access patterns~\cite{paperOpenGL} 
  in 2025.
  \\
