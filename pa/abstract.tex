\begin{titlepage}
    \section*{Abstract}
        ...
        % Climax Experiment
        Additionally, \mbox{TRRespass} was adapted to ARM to evaluate effective access patterns 
        ...
        to Rowhammer on contemporary Raspberry Pi hardware. 
        Under the tested conditions, no susceptibility to Rowhammer was observed on modern Raspberry Pi
        models, regardless of model or RAM configuration. Hardware protections and \gls{dram} page 
