\section{Address Mapping Reconstruction} \label{sec:targeted}
    ...
    induce bit flips in adjacent victim rows, denoted as "\textit{\hyperref[ch:targeted]{C2. Address Mapping Reconstruction}}". The physical address is 
    ...
    \subsection{Knock-Knock Approach} \label{subsec:knock-knock-approach}
        ...
        Despite multiple measurement runs exceeding 20 hours in total, we did not observe any bit flips. The 
    ...
    \subsection{Verification} \label{subsec:verification}
        ...
        same model exhibits Rowhammer bit flips~\cite{paperDrammer,thesisCacheAttacksandRH}.
        \\
