\subsection{Reverse Engineering} \label{subsec:reverse-engineering}
    \subsubsection{Graph-Based Mapping Inference} \label{subsubsec:graph-based-mapping-inference}
        Building on the timing-channel primitive introduced in~\cite{paperOneBitFlipsOneCouldFlops}, a novel 
        ...
        via \texttt{vmalloc} was introduced to accommodate larger arrays. The results are stored in 
