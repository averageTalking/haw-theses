\section{Outpacing DRAM Refresh} \label{sec:fast}
    ...
    \subsection{Bypass Techniques} \label{subsec:bypass-techniques}
        ...
        Rowhammer tests failed to induce bitflips, even though the official Micron documentation suggests 
        ...
        amplitude to bypass modern in-\gls{dram} \gls{trr} mitigations and successfully induce bitflips. TRRespass~\cite{paperTRRespass},
        ...
        natively rebuilding the Linux kernel, as described in~\cref{subsec:lab-setup}.
        \\
