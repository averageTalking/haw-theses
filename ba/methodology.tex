\section{Methodology} \label{sec:methodology}
  ...
  \subsection{Research Design} \label{subsec:research-design}
    ...
    Raspberry Pi 5 models with 4~GB, 8~GB, and 16 GB of RAM 
    (see \hyperref[tab:experimental-setups]{Table~\ref{tab:experimental-setups}}). 
    ...
    than the Raspberry Pi 3B~\cite{webProcessors}. The Raspberry Pi 5 devices include a Quad Core ARMv8 Cortex-A76 \gls{cpu} 
    ...
    % Data Sources
    The primary data sources consisted of related academic papers from conferences such 
    as ACM, IEEE, and others, providing the theoretical foundation. Supplementary 
