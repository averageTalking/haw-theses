\subsection{Reverse Engineering} \label{subsec:reverse-engineering}
    \subsubsection{Graph-Based Mapping Inference} \label{subsubsec:graph-based-mapping-inference}
        Building on the timing-channel primitive introduced in [93], a novel 
        ...
        \\
        The workflow involves porting, building and executing the tool [118] by including several ARM-specific
        ...
        consistency aligns with findings from related work, particularly the mapping of [79], as well of the 
        [74] mapping. However, due to the lack of pronounced 
