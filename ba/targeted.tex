\section{Address Mapping Reconstruction} \label{sec:targeted}
    ...
    \subsection{Methods} \label{subsec:methods}
        ...
        reducing the search space of the exponential-time~\cite{paperKnockKnock}. This method is employed, for example, by 
        the DRAM MaUT tool~\cite{paperDRAMMaUT}.
        \\
    ...
    \subsection{Verification} \label{subsec:verification}
        ...
        \\
        The verification can be performed using the DRAMA methodology~\cite{paperDRAMA,toolDrama}. In this approach, memory 
