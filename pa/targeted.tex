\section{Targeted} \label{sec:targeted}
    ...
    \subsection{Methods} \label{subsec:methods}
        ...
        a linked list across the physical address space. This traversal enforces continuous \gls{dram} accesses 
        ...
        about specific \gls{dram} chip geometries and processor microarchitectural characteristics in order to 
        reduce the search space of the otherwise exponential-time search. This approach is used, for example, 
        by the \gls{dram} MaUT tool [79].
        \\
        ...
        \\
        \textit{Knock Knock}, introduced by Plin et al. in 2025 [99], reformulates the identification of \gls{dram} parity 
