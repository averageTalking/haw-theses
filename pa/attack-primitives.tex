\section{Attack Primitives} \label{sec:attack-primitives}
  ...
  \begin{description}
    \item[P1. Uncached]
      The first prerequisite requires that memory accesses bypass 
    ...
    \item[P2. Targeted]
      The second prerequisite specifies that memory accesses must be directed to 
    ...
    \item[P3. Fast]
      The third prerequisite demands that memory accesses occur at a rate that outpaces 
