\section{Address Mapping Reconstruction} \label{sec:targeted}
    ...
    \subsection{Methods} \label{subsec:methods}
        \textbf{PALLOC}, introduced by Yun et al.~\cite{paperPALLOC} in 2014, uses a dedicated microbenchmark 
        ...
        \\
        \textbf{DRAMA}, proposed by Pessl et al.~\cite{paperDRAMA} in 2016, exploits the row-buffer timing side 
        ...
        \\
        \textbf{Reliable RE}, presented by Helm et al.~\cite{paperReliableReverseEngineering} in 2020, extends DRAMA by integrating 
        performance counters, which identifies row hits and misses more reliable 
        during the reverse-engineering process.
        \\
        \textbf{DRAMDig}, introduced by Wang et al.~\cite{paperDRAMDig} in 2020, builds upon DRAMA by incorporating 
        ...
        \\
        \textbf{One Bitflip One Cloud Flop}, described by Xiao et al.~\cite{paperOneBitFlipsOneCouldFlops} in 2016, proposes a graph-based 
        ...
        \\
        \textbf{Knock-Knock}, introduced by Plin et al.~\cite{paperKnockKnock} 2025, reformulates the identification of 
    ...
    \subsection{Knock-Knock Approach} \label{subsec:knock-knock-approach}
        ...
        we focused on testing one-location hammering using the ported FlipFloyd tool on our ARM-based platform. 
