\section{Uncached} \label{sec:uncached}
    ...
    \subsection{Non-temporal accesses} \label{subsec:non-temporal-accesses}
        ...
        cached in practice [~Triggering RH]. Conceptually, non-temporal operations do not follow 
    ...
    \subsection{Uncached memory} \label{subsec:uncached-memory}
        ...
        bypass \gls{cpu} caches has been explored in [38] [Quote of Triggering RH]. Despite its effectiveness on 
