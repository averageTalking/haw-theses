\section{Overview of Challenges} \label{sec:overview-of-challenges}
  ...
  \begin{tcolorbox}[challengebox={C1. Uncached}] \label{ch:uncached}
  ...
  \begin{tcolorbox}[challengebox={C2. Targeted}] \label{ch:targeted}
  ...
  \begin{tcolorbox}[challengebox={C3. Fast}] \label{ch:fast}
