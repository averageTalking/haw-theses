\section{Address Mapping Reconstruction} \label{sec:targeted}
    ...
    However, just like on Intel systems, details of this mapping are not publicly disclosed, unlike the 
    ...
    \subsection{Verification} \label{subsec:verification}
        ...
        proportionally to the number of identified sets~\cite{paperDRAMA}. However, this method is often impractical due 
