\begin{titlepage}
    \section*{Abstract}
        ...
        % Experiments
        In this work, a Rowhammer proof-of-concept was developed for the Raspberry 
        Pi 4 and 5. Cache bypass methods were implemented via eviction strategies 
        and ARM cache maintenance instructions, enabling direct \gls{dram} access. \gls{dram} 
        address mapping was reconstructed by ported ARM-compatible DRAMA tool to 
        allow targeted row accesses.
        % Climax Experiment
        Additionally, TRRespass was adapted to ARM to test effective access patterns 
        for hammering designed to induce bit flips.
        ...
        reproducible bit flips were observed. Hardware protections and \gls{dram} page 
