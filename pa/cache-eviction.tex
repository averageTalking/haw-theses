\subsection{Cache eviction} \label{subsec:cache-eviction}
    ...
    \subsubsection{Eviction Development} \label{subsubsec:eviction-development}
        The cache eviction mechanism used in this work is based on the libflush tool~\cite{toolArmageddon} and relies on the 
        construction and use of eviction sets. 
        \\
        % Eviction Set Structure
        The eviction set structure, as defined in \hyperref[lst:eviction-set-structure]{Listing~\ref{lst:eviction-set-structure}}, consists of multiple virtual 
        ...
        addresses contained in an eviction set (see \hyperref[lst:eviction-function]{Listing~\ref{lst:eviction-function}}). During execution, 
        ...
        address (see \hyperref[lst:cache-set-determination]{Listing~\ref{lst:cache-set-determination}}). This is achieved by computing the set index from the 
        ...
        provided by the libflush tool~\cite{toolArmageddon} is adopted (see \hyperref[lst:default]{Listing~\ref{lst:default}}).
