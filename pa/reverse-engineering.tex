\subsection{Reverse Engineering} \label{subsec:reverse-engineering}
    ...
    \subsubsection{Row Hit, Row Conflict Distinction} \label{subsubsec:row-hit-row-conflict-distinction}
        ...
        information. Three types of access patterns are considered~\cite{paperDRAMA} and presented in~\cref{fig:cases}. 
        \\
    ...
    \subsubsection{Bank Function Derivation} \label{subsubsec:bank-function-derivation}
        ...
        to~\cite{toolRowhammer_armv8}, was added to replace \texttt{CLFLUSH}. The \texttt{-march=armv8-a} compiler flag was used to ensure optimized 
        ARM code generation.
        \\
