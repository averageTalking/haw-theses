\section{Lab Setup} \label{sec:lab-setup}
  ...
  \subsection{System Setup} \label{subsec:system-setup}
    ...
    The term ARM denotes a family of \gls{risc} architectures [26], within which ARMv7-A and ARMv8-A constitute two major 
    application-profile generations. The ARMv7-A architecture is limited to 32-bit execution, 
    whereas ARMv8-A, supports both 32-bit and 64-bit computation [48]. Although ARMv7-A processors remain in 
    ...
    platform. The official Raspberry Pi Linux kernel source code [187] was then cloned, restricted to the latest 
